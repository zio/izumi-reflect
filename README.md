...
5. At the moment Scala 3 port does not support Path-Dependent Types, `<:<` fails on parameterized base classes and does not take into account variance of parameterized types. This will be fixed in future.
